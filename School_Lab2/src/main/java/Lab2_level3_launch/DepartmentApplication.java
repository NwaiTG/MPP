...
public class DepartmentApplication {
    public static void main(String[] args) throws IOException {
        ...
        StudentStaff Gore = new StudentStaff("Gore","472-3321",33,3.7, 2500);
        StudentStaff Davis = new StudentStaff("Davis","472-7552",50,4.0, 2000);
        StudentStaff Heck = new StudentStaff("Heck","472-8890",29,4.3, 2200);
        dept.addPerson (Gore);
        ...
        while(true)
        {
            ...
            switch(choice)
            {
                ...
                case 'p':
                    ...
                    dept.printAllStudentsOfFaculty(facultyName);
                case 'q': return;
                default:
